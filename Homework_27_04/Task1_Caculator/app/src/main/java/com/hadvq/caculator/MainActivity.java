...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOpposite = (Button) findViewById(R.id.button_opposite);
        textViewInputNumbers = (TextView) findViewById(R.id.textView_input_numbers);
        textViewOutput = (TextView) findViewById(R.id.textView_output_numbers);
    }
        ...
        if (operationLength > 0) {
            ...
            if ((lastInput.equals("+") || lastInput.equals("-") || lastInput.equals("*") || lastInput.equals("/") || lastInput.equals("%"))) {
                ...
                if(first ==0){
                    ...
                    textViewInputNumbers.setText(textViewOutput.getText() + operand);
                }
